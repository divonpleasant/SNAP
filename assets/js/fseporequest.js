function fsepoauth(event) {
    ...
    (debug_mode) ? console.log("[DEBUG] fsepo_serial_num_strings: " + fsepo_serial_num_strings) : '';
    ...
    var body = "Dear " + localContactPerson + ",\n\n" +
               ...
               "The Zeiss Technician will contact the office within four (4) business hours to schedule the visit. " +
