function fsepoauth(event) {
    ...
    debugmsg(1, 'Executing fseporequest.js...');
    ...
    const fsepo_serial_num_strings = proc_template_serial(serial);
    debugmsg(5, 'fsepo_serial_num_strings: ' + fsepo_serial_num_strings);
    var subj_serial = fsepo_serial_num_strings[0];
    var instrument_str = fsepo_serial_num_strings[1];
    var paren_serial = fsepo_serial_num_strings[2];
    debugmsg(5, 'subj_serial: ' + subj_serial);
    debugmsg(5, 'instrument_str: ' + instrument_str);
    debugmsg(5, 'paren_serial: ' + paren_serial);
    ...
    var body = "Dear " + localContactPerson + ",\n\n" +
               ...
               "This approval would be for the minimum amount of $3,500.00 USD [Dispatch a Field Service Engineer (FSE)].\n\n" +
               ...
               "The Zeiss Technician will contact the office within four (4) business hours to schedule the visit. At which time, they will answer all questions regarding specific prices, hourly rates, and travel time. Or, after discussing pricing with your FSE, you may cancel the service request.\n\n" +
               "Regards,\n\n" + email_sig + "\n";
